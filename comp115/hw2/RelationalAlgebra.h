...
// Return the input table with the columns renamed according to the name_map.
// E.g. if the input has columns (a, b), then a name_map of {{"a", "x"}, {"b", "y"}} 
// will yield a table with columns named (x, y). Each column must be renamed.
